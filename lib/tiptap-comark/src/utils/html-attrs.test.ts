 ...
 *
 * `htmlAttrSpec` produces parseHTML / renderHTML callbacks that rely on a
 * real DOM (HTMLElement, attribute iteration). happy-dom is light enough
 * that flipping just this one file pays for itself.
 */
